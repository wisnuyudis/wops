            ...
            <div class="card-body">
                <form action="{{ route('sors.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sor') is-invalid @enderror" 
                                       id="sor" name="sor" value="{{ old('sor') }}" required>
                                @error('sor')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('init_date') is-invalid @enderror" 
                                       id="init_date" name="init_date" value="{{ old('init_date') }}" required>
                                @error('init_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary m-0">Create SOR</button>
                    </div>
                </form>
            </div>
        </div>
