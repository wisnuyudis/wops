                ...
                <form action="{{ route('daily-activities.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('action') is-invalid @enderror" id="action" name="action" required>
                            ...
                            <option value="Cust Call" {{ old('action') == 'Cust Call' ? 'selected' : '' }}>Cust Call</option>
                            <option value="Online Meet" {{ old('action') == 'Online Meet' ? 'selected' : '' }}>Online Meet</option>
                            <option value="Remote" {{ old('action') == 'Remote' ? 'selected' : '' }}>Remote</option>
                            <option value="Visit" {{ old('action') == 'Visit' ? 'selected' : '' }}>Visit</option>
                            <option value="sdt Internal" {{ old('action') == 'sdt Internal' ? 'selected' : '' }}>sdt Internal</option>
                            <option value="Event" {{ old('action') == 'Event' ? 'selected' : '' }}>Event</option>
                            <option value="Training" {{ old('action') == 'Training' ? 'selected' : '' }}>Training</option>
                        </select>
                        @error('action')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
